  ...
  const slides = [
    {
      ...
      desc: "Tech Connect APAC connects top talent with leading companies, driving growth and success.",
      path: "/contact",
      img: herobannerImage1,
    },
    {
      title: "For Candidates",
      desc: "Your Career, Our Priority",
      path: "/contact",
      img: herobannerImage2,
    },
    {
      title: "For Employers",
      desc: "Find Your Next Great Hire",
      path: "/contact",
