...
const Blogs3 = ({ blogsType }) => {
  const blogs = getAllBlogs()?.filter(({ id }) => id === 1 || id === 2);
  return (
    <div
      className={`${
        blogsType === 4
          ...
          >
            ...
            >
              ...
              <div className="blog__4__section__title__text">
                <p>
                  Explore expert insights, in-depth analysis, and the latest
                  trends in our industry. Stay informed with our latest blog
                  updates.
                </p>
              </div>
              <div className="section__title__button">
